...
class ChildHolder(val componentContext: ComponentContext) {
...
fun <B : Component.Builder<B>> ChildHolder.componentBuilder(
        create: (c: ComponentContext) -> B,
        init: B.() -> Unit) {
    val builder = create(componentContext)
    builder.init()
...
fun <B : Component.ContainerBuilder<B>> Component.ContainerBuilder<B>.children(
    ...
    val childHolder = ChildHolder(componentContext)
    childHolder.init()
...
@LithoMarker
fun ChildHolder.column(init: Column.Builder.() -> Unit) =
        componentBuilder(componentContext, Column::create, init)
...
@LithoMarker
fun ChildHolder.row(init: Row.Builder.() -> Unit) =
        componentBuilder(componentContext, Row::create, init)
...
@LithoMarker
fun ChildHolder.card(init: Card.Builder.() -> Unit) =
        componentBuilder(componentContext, Card::create, init)
...
fun ChildHolder.cardClip(c: ComponentContext, init: CardClip.Builder.() -> Unit) =
        componentBuilder(componentContext, CardClip::create, init)
...
fun ChildHolder.editText(c: ComponentContext, init: EditText.Builder.() -> Unit) =
        componentBuilder(componentContext, EditText::create, init)
...
fun ChildHolder.empty(c: ComponentContext, init: EmptyComponent.Builder.() -> Unit) =
        componentBuilder(componentContext, EmptyComponent::create, init)
...
@LithoMarker
fun ChildHolder.horizontalScroll(init: HorizontalScroll.Builder.() -> Unit) =
        componentBuilder(componentContext, HorizontalScroll::create, init)
...
@LithoMarker
fun ChildHolder.image(init: Image.Builder.() -> Unit) =
        componentBuilder(componentContext, Image::create, init)
...
@LithoMarker
fun ChildHolder.progress(init: Progress.Builder.() -> Unit) =
        componentBuilder(componentContext, Progress::create, init)
...
@LithoMarker
fun ChildHolder.lazySelector(init: LazySelectorComponent.Builder.() -> Unit) =
        componentBuilder(componentContext, LazySelectorComponent::create, init)
...
@LithoMarker
fun ChildHolder.recycler(init: Recycler.Builder.() -> Unit) =
        componentBuilder(componentContext, Recycler::create, init)
...
@LithoMarker
fun ChildHolder.recyclerCollectionComponent(init: RecyclerCollectionComponent.Builder.() -> Unit) =
        componentBuilder(componentContext, RecyclerCollectionComponent::create, init)
...
@LithoMarker
fun ChildHolder.selector(init: SelectorComponent.Builder.() -> Unit) =
        componentBuilder(componentContext, SelectorComponent::create, init)
...
@LithoMarker
fun ChildHolder.solidColor(init: SolidColor.Builder.() -> Unit) =
        componentBuilder(componentContext, SolidColor::create, init)
...
@LithoMarker
fun ChildHolder.text(init: Text.Builder.() -> Unit) =
        componentBuilder(componentContext, Text::create, init)
...
@LithoMarker
fun ChildHolder.verticalScroll(init: VerticalScroll.Builder.() -> Unit) =
        componentBuilder(componentContext, VerticalScroll::create, init)